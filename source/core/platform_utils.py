"""
Platform-specific utilities for UE Plugin Builder.
...
class WindowsHandler(PlatformHandler):
    ...
    def get_config_dir(self) -> Path:
        ...
        if local_appdata:
            return Path(local_appdata) / "UEPluginBuilder"
        return Path.home() / "AppData" / "Local" / "UEPluginBuilder"
...
class LinuxHandler(PlatformHandler):
    ...
    def get_config_dir(self) -> Path:
        ...
        if xdg_config:
            return Path(xdg_config) / "ue-plugin-builder"
        return Path.home() / ".config" / "ue-plugin-builder"
...
class MacOSHandler(PlatformHandler):
    ...
    def get_config_dir(self) -> Path:
        return Path.home() / "Library" / "Application Support" / "UEPluginBuilder"
